...
class SimulationConfig:
    def __init__(self, configFilePath=None):
        ...
        self.string_dict = {
                "dof": config["dynamics"]["dof"],
                "alpha_mat": np.identity(config["dynamics"]["dof"]),
                "beta_mat": np.identity(config["dynamics"]["dof"]),
                "T": config["dynamics"]["T"],
                "period": config["dynamics"]["period"],
                "scaling": config["dynamics"]["scaling"],
